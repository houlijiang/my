...
<script src="/js/dwz/js/jquery-1.7.2.min.js"></script>
</head>
...
<body>
	<div id="login">
		...
		<div id="login_content">
			<div class="loginForm">
				<form action="/admin.php/user/login" method="post" onsubmit="return false">
					<p>
						<label>用户名：</label>
...
function login(){
	...
	$.post('<?php echo site_url("/user/login")?>',json,function(data){
